<template>
	<view class="bg">
		...
		<view class="flex1">
			...
			<view @click="bs1(3)" :class="blue1==3?'blue':''">
				收款成功
			</view>
			<view @click="bs1(4)" :class="blue1==4?'blue':''">
				收款失败
			</view>
		</view>
		...
		<w-picker :mode="mode" startYear="2019" endYear="2030" step="1" :defaultVal="defaultVal" :current="true" @confirm="onConfirm1"
