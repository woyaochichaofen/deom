	...
	<view class="bigbg">
		...
		<view class="input">
			<view class="flex">
				...
				<view class="">
					<input type="number" @input="ewm1" value="" placeholder-class="naocan" placeholder="请输入验证码" />
				</view>
			</view>
		...
		<view class="input">
			<view class="flex">
				...
				<view class="">
					<input type="number" @input="ewm2" value="" placeholder-class="naocan" placeholder="请输入验证码" />
				</view>
			</view>
		</view>
...
<script>
	export default {
		...
		methods: {
			...
			ewm1(e) {
				this.two1 = e.detail.value
			},
			ewm2(e) {
				this.two2 = e.detail.value
			},
			yzm() {
				let that = this
				if (this.one) {
